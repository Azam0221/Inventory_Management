...
- **Inventory Tracking:** Create inventory records mapped to products and suppliers.
- **Order Processing:** Handle purchase orders and sale orders.
...
- **Database:**  MySQL
- **ORM:** Spring Data JPA 
- **Email:** Spring Mail with Google App Password
